...
public class Authenticator {
    public static String obtenerNombreDeArchivo(String[] args) {
        // (3 puntos) TODO Comprueba que viene el argumento y devuelve el nombre del
        // archivo en caso correcto
        if (args.length == 1) {
            return args[0];
        }
        return "";
    ...
    public static void main(String[] args) {
        ...
        if ((file = obtenerNombreDeArchivo(args)).equals("")) {
            // (2 puntos) TODO Indica un mensaje de error y sal del programa con
            // System.exit(-1)
            System.out.println("Error, debe indicar el nombre de archivo");
            System.exit(-1);
                ...
                if (usuarioAutenticado == null) {
                    ...
                    switch (opcion) {
                        case 1:
                            ...
                            if (usuarioAutenticado != null) {
                                System.out.println("\n****************************");
                                System.out.printf("Bienvenido %s %s", usuarioAutenticado.getNombre(),
